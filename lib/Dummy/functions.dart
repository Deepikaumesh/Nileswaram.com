...
String uploadAPI = 'https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/upload.php';
//String getAPI = '$api/getUserProfile.php';
String getAPI = 'https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/get_image.php';
...
//  required String password,
  required String image, required String address,
}) async {
  try {
...
Future getUserProfile({required String name}) async {
  try {
    final response = await http.post(
      Uri.parse(getAPI),
      body: {'name': name,},
