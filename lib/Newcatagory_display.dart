...
Future<List<User>> getRequest() async {
  ...
  String url =
      "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/New_catagory_Display.php";
  // old  table textile
...
class New_Cato extends StatefulWidget {
  const New_Cato({Key? key}) : super(key: key);

  @override
  _New_CatoState createState() => _New_CatoState();
}

class _New_CatoState extends State<New_Cato> {
  @override
