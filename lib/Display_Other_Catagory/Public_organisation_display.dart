...
class Organisation_Display_with_searchbar extends StatefulWidget {
  const Organisation_Display_with_searchbar({Key? key}) : super(key: key);

  @override
  _Organisation_Display_with_searchbarState createState() => _Organisation_Display_with_searchbarState();
}

class _Organisation_Display_with_searchbarState extends State<Organisation_Display_with_searchbar> {


  List<Note> _notes = [];
  List<Note> _notesForDisplay =[];
  Future <List<Note>> fetchNotes() async{
    var url ="https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Organisation_Display.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Organisations",style: GoogleFonts.prompt(color: Colors.red.shade900),),
          ...
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) {
                  return Public_organisation_Detail(_notesForDisplay[index]);
                }
                )
            );
          }
...
//     String url ="https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Organisation_Display.php";
//
//
//
