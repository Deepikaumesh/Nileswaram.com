...
class Barbershop_RegPage extends StatefulWidget {
  @override
  _Barbershop_RegPageState createState() => _Barbershop_RegPageState();
}

class _Barbershop_RegPageState extends State<Barbershop_RegPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Barbershop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
