...
class Fruits$Veg_RegPage extends StatefulWidget {
  @override
  _Fruits$Veg_RegPageState createState() => _Fruits$Veg_RegPageState();
}

class _Fruits$Veg_RegPageState extends State<Fruits$Veg_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Fruits&Veg_Reg.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Fruits&Vegitable Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
