...
class MedicalShop_RegPage extends StatefulWidget {
  @override
  _MedicalShop_RegPageState createState() => _MedicalShop_RegPageState();
}

class _MedicalShop_RegPageState extends State<MedicalShop_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Medical_shop_Reg.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Medical Shop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
