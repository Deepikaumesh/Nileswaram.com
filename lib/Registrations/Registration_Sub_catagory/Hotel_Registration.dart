...
class Hote_Reg_Page extends StatefulWidget {
  @override
  _Hote_Reg_PageState createState() => _Hote_Reg_PageState();
}

class _Hote_Reg_PageState extends State<Hote_Reg_Page> {
  ...
  late bool status;
  late String message;
  String serverUrl = "https://astrasoftware.in/directoryapp/Nileswaram.com/Catagory_Registration/Hotel_Registration.php";
