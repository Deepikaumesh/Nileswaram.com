...
class hospital_Reg_Page extends StatefulWidget {
  @override
  _hospital_Reg_PageState createState() => _hospital_Reg_PageState();
}

class _hospital_Reg_PageState extends State<hospital_Reg_Page> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Hospital_Reg.php";

  @override
  void initState() {
    name = TextEditingController(text: 'hospital-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Hospital Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
