...
class Hardware_Reg_Page extends StatefulWidget {
  @override
  _Hardware_Reg_PageState createState() => _Hardware_Reg_PageState();
}

class _Hardware_Reg_PageState extends State<Hardware_Reg_Page> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Hardware_Reg.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Hardware Shop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
