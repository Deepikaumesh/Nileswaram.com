...
class Grocery_Reg_Page extends StatefulWidget {
  @override
  _Grocery_Reg_PageState createState() => _Grocery_Reg_PageState();
}

class _Grocery_Reg_PageState extends State<Grocery_Reg_Page> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Grocery_Reg.php";

  @override
  void initState() {
    name = TextEditingController(text: 'grocery shop-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Grocery Shop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
