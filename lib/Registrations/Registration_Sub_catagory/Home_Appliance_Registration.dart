...
class HomeAplliance_RegPage extends StatefulWidget {
  @override
  _HomeAplliance_RegPageState createState() => _HomeAplliance_RegPageState();
}

class _HomeAplliance_RegPageState extends State<HomeAplliance_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/HomeApplianc_Reg.php";

  @override
  void initState() {
    name = TextEditingController(text: 'home appliance-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Home Appliance",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
