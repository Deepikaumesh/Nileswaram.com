...
class Beauty_Parler_RegPage extends StatefulWidget {
  @override
  _Beauty_Parler_RegPageState createState() => _Beauty_Parler_RegPageState();
}

class _Beauty_Parler_RegPageState extends State<Beauty_Parler_RegPage> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Beautiparler_Reg.php";

  @override
  void initState() {
    name = TextEditingController(text: 'beautyparler-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Beautyparler Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
