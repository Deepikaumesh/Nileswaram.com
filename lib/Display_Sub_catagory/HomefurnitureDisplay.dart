...
class Display_homefurniture_data extends StatefulWidget {
  @override
  _Display_homefurniture_dataState createState() => _Display_homefurniture_dataState();
}

class _Display_homefurniture_dataState extends State<Display_homefurniture_data> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/sub_catagory_Display/homefurniture.php";
    // old  table textile
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              image: AssetImage('assets/hf.png'),
                                              fit: BoxFit.fill
                                          ),
                                        ),
                                      ),
