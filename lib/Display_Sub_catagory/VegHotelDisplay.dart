...
class Display_Veghotel_data extends StatefulWidget {
  @override
  _Display_Veghotel_dataState createState() => _Display_Veghotel_dataState();
}

class _Display_Veghotel_dataState extends State<Display_Veghotel_data> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/sub_catagory_Display/veghotel.php";
    // old  table textile
