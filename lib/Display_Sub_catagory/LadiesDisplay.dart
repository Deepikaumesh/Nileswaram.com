...
class Display_Ladies_data extends StatefulWidget {
  @override
  _Display_Ladies_dataState createState() => _Display_Ladies_dataState();
}

class _Display_Ladies_dataState extends State<Display_Ladies_data> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/sub_catagory_Display/ladies.php" ;// old  table textile
