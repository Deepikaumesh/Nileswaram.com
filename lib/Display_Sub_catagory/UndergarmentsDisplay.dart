...
class Display_undergarments_data extends StatefulWidget {
  @override
  _Display_undergarments_dataState createState() => _Display_undergarments_dataState();
}

class _Display_undergarments_dataState extends State<Display_undergarments_data> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/sub_catagory_Display/undergarments.php";
    // old  table textile
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                    image: AssetImage('assets/panties.png'),
                                                    fit: BoxFit.fill
                                                ),
                                              ),
                                            ),
