...
class Display_Gents_data extends StatefulWidget {
  @override
  _Display_Gents_dataState createState() => _Display_Gents_dataState();
}

class _Display_Gents_dataState extends State<Display_Gents_data> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/sub_catagory_Display/gents.php";
    // old  table textile
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                    image: AssetImage('assets/gents.png'),
                                                    fit: BoxFit.fill
                                                ),
                                              ),
                                            ),
