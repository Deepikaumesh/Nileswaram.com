...
class Bricks_Flyash_Display extends StatefulWidget {
  @override
  _Bricks_Flyash_DisplayState createState() => _Bricks_Flyash_DisplayState();
}

class _Bricks_Flyash_DisplayState extends State<Bricks_Flyash_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/bricks_flyash.php";
