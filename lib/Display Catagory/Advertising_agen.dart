...
class Advertising_agen_Display extends StatefulWidget {
  @override
  _Advertising_agen_DisplayState createState() => _Advertising_agen_DisplayState();
}

class _Advertising_agen_DisplayState extends State<Advertising_agen_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/advertising.php";
    // old  table textile
