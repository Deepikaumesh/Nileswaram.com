...
class Awards_Display extends StatefulWidget {
  @override
  _Awards_DisplayState createState() => _Awards_DisplayState();
}

class _Awards_DisplayState extends State<Awards_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/awards_trphies_wholesale.php";
    // old  table textile
