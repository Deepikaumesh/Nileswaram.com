...
class Allergist_Display extends StatefulWidget {
  @override
  _Allergist_DisplayState createState() => _Allergist_DisplayState();
}

class _Allergist_DisplayState extends State<Allergist_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/allergist.php";
    // old  table textile
