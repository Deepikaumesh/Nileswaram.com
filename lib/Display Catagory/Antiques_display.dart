...
class Antiques_Display extends StatefulWidget {
  @override
  _Antiques_DisplayState createState() => _Antiques_DisplayState();
}

class _Antiques_DisplayState extends State<Antiques_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/antiques.php";
    // old  table textile
