...
class Bakery_Productssales_Display extends StatefulWidget {
  @override
  _Bakery_Productssales_DisplayState createState() => _Bakery_Productssales_DisplayState();
}

class _Bakery_Productssales_DisplayState extends State<Bakery_Productssales_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/beker_productsales.php";
