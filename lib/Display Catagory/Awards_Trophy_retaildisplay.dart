...
class Awards_retail_Display extends StatefulWidget {
  @override
  _Awards_retail_DisplayState createState() => _Awards_retail_DisplayState();
}

class _Awards_retail_DisplayState extends State<Awards_retail_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/awards_trophiesretails.php";
    // old  table textile
