...
class ACP_Display extends StatefulWidget {
  @override
  _ACP_DisplayState createState() => _ACP_DisplayState();
}

class _ACP_DisplayState extends State<ACP_Display> {
...
//Applying get request.
  ...
  Future<List<User>> getRequest() async {
    ...
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/acp.php";
