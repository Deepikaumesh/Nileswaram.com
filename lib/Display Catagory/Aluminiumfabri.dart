...
class Aluminiumfabri_Display extends StatefulWidget {
  @override
  _Aluminiumfabri_DisplayState createState() => _Aluminiumfabri_DisplayState();
}

class _Aluminiumfabri_DisplayState extends State<Aluminiumfabri_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/aluminium.php";
    // old  table textile
