...
class Airconditioners_Display extends StatefulWidget {
  @override
  _Airconditioners_DisplayState createState() => _Airconditioners_DisplayState();
}

class _Airconditioners_DisplayState extends State<Airconditioners_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/aircondi.php";
    // old  table textile
