...
class Automobile_body_Display extends StatefulWidget {
  @override
  _Automobile_body_DisplayState createState() => _Automobile_body_DisplayState();
}

class _Automobile_body_DisplayState extends State<Automobile_body_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/automobile.php";
    // old  table textile
