...
class Advocate_Display extends StatefulWidget {
  @override
  _Advocate_DisplayState createState() => _Advocate_DisplayState();
}

class _Advocate_DisplayState extends State<Advocate_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/advocate.php";
    // old  table textile
