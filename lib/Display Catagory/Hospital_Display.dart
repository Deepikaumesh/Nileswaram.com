...
class hospital_Display extends StatefulWidget {
  @override
  _hospital_DisplayState createState() => _hospital_DisplayState();
}

class _hospital_DisplayState extends State<hospital_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/Hospital/hospital.php";
    // old  table textile
    // old  table textile
