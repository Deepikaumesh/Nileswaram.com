...
class Bricks_Country_Display extends StatefulWidget {
  @override
  _Bricks_Country_DisplayState createState() => _Bricks_Country_DisplayState();
}

class _Bricks_Country_DisplayState extends State<Bricks_Country_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/bricks_country.php";
