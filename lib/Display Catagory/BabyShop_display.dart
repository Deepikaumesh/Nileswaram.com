...
class Babyshop_Display extends StatefulWidget {
  @override
  _Babyshop_DisplayState createState() => _Babyshop_DisplayState();
}

class _Babyshop_DisplayState extends State<Babyshop_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/babyshop.php";
