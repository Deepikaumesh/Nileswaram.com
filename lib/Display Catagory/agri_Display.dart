...
class Agri_Display extends StatefulWidget {
  @override
  _Agri_DisplayState createState() => _Agri_DisplayState();
}

class _Agri_DisplayState extends State<Agri_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/agri.php";
    // old  table textile
