...
class Ambulance_Display extends StatefulWidget {
  @override
  _Ambulance_DisplayState createState() => _Ambulance_DisplayState();
}

class _Ambulance_DisplayState extends State<Ambulance_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/ambulance.php";
    // old  table textile
