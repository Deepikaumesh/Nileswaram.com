...
class Audio_Video_Display extends StatefulWidget {
  @override
  _Audio_Video_DisplayState createState() => _Audio_Video_DisplayState();
}

class _Audio_Video_DisplayState extends State<Audio_Video_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/audiovideo.php";
    // old  table textile
