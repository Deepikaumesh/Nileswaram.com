...
class Blogger_Display extends StatefulWidget {
  @override
  _Blogger_DisplayState createState() => _Blogger_DisplayState();
}

class _Blogger_DisplayState extends State<Blogger_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/blogger.php";
