...
class Borewell_Contractor_Display extends StatefulWidget {
  @override
  _Borewell_Contractor_DisplayState createState() => _Borewell_Contractor_DisplayState();
}

class _Borewell_Contractor_DisplayState extends State<Borewell_Contractor_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/borewell_contractor.php";
