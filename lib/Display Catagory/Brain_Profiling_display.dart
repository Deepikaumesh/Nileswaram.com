...
class Brain_Profiling_Display extends StatefulWidget {
  @override
  _Brain_Profiling_DisplayState createState() => _Brain_Profiling_DisplayState();
}

class _Brain_Profiling_DisplayState extends State<Brain_Profiling_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/brain_profiling.php";
