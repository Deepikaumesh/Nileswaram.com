...
class Agri_seeds_Display extends StatefulWidget {
  @override
  _Agri_seeds_DisplayState createState() => _Agri_seeds_DisplayState();
}

class _Agri_seeds_DisplayState extends State<Agri_seeds_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/agriseeds.php";
    // old  table textile
