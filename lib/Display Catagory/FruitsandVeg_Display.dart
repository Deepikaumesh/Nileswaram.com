...
class Fruits_Veg_Display extends StatefulWidget {
  @override
  _Fruits_Veg_DisplayState createState() => _Fruits_Veg_DisplayState();
}

class _Fruits_Veg_DisplayState extends State<Fruits_Veg_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/fruits&veg/fruits&veg.php";
    // old  table textile
