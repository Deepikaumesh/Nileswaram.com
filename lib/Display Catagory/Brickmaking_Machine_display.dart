...
class Brickmaking_Machine_Display extends StatefulWidget {
  @override
  _Brickmaking_Machine_DisplayState createState() => _Brickmaking_Machine_DisplayState();
}

class _Brickmaking_Machine_DisplayState extends State<Brickmaking_Machine_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/brickmaking_machines.php";
