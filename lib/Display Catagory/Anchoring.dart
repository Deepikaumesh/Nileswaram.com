...
class Anchoring_Display extends StatefulWidget {
  @override
  _Anchoring_DisplayState createState() => _Anchoring_DisplayState();
}

class _Anchoring_DisplayState extends State<Anchoring_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/anchoring.php";
    // old  table textile
