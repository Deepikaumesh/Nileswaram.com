...
class Automation_products_therapist extends StatefulWidget {
  @override
  _Automation_products_therapistState createState() => _Automation_products_therapistState();
}

class _Automation_products_therapistState extends State<Automation_products_therapist> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/automationproducts.php";
    // old  table textile
