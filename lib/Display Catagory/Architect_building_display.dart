...
class architect_building_Display extends StatefulWidget {
  @override
  _architect_building_DisplayState createState() => _architect_building_DisplayState();
}

class _architect_building_DisplayState extends State<architect_building_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/architect_building.php";
    // old  table textile
