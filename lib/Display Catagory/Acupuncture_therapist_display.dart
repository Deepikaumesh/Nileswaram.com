...
class Acupuncture_therapist extends StatefulWidget {
  @override
  _Acupuncture_therapistState createState() => _Acupuncture_therapistState();
}

class _Acupuncture_therapistState extends State<Acupuncture_therapist> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/acupun.php";
    // old  table textile
