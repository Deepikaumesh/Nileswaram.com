...
class Architect_interior_Display extends StatefulWidget {
  @override
  _Architect_interior_DisplayState createState() => _Architect_interior_DisplayState();
}

class _Architect_interior_DisplayState extends State<Architect_interior_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/architect_interior.php";
    // old  table textile
