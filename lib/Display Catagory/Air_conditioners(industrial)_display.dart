...
class Airconditioner_Industrial_Display extends StatefulWidget {
  @override
  _Airconditioner_Industrial_DisplayState createState() => _Airconditioner_Industrial_DisplayState();
}

class _Airconditioner_Industrial_DisplayState extends State<Airconditioner_Industrial_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/aircondi_Industrial.php";
    // old  table textile
