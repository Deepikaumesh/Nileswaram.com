...
class BeautyParler_Display extends StatefulWidget {
  @override
  _BeautyParler_DisplayState createState() => _BeautyParler_DisplayState();
}

class _BeautyParler_DisplayState extends State<BeautyParler_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/Beautyparler/beautyparler.php";
    // old  table textile
