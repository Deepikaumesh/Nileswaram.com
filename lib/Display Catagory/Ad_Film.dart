...
class Ad_Film_Maker extends StatefulWidget {
  @override
  _Ad_Film_MakerState createState() => _Ad_Film_MakerState();
}

class _Ad_Film_MakerState extends State<Ad_Film_Maker> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/adfilm.php";
    // old  table textile
