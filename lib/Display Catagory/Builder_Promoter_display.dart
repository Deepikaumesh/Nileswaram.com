...
class Builder_Promoter_Display extends StatefulWidget {
  @override
  _Builder_Promoter_DisplayState createState() => _Builder_Promoter_DisplayState();
}

class _Builder_Promoter_DisplayState extends State<Builder_Promoter_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/builder_promoter.php";
