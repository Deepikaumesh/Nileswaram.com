...
class Apartment_Display extends StatefulWidget {
  @override
  _Apartment_DisplayState createState() => _Apartment_DisplayState();
}

class _Apartment_DisplayState extends State<Apartment_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/apartment.php";
    // old  table textile
