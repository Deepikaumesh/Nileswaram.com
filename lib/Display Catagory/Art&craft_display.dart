...
class Art_craft_Display extends StatefulWidget {
  @override
  _Art_craft_DisplayState createState() => _Art_craft_DisplayState();
}

class _Art_craft_DisplayState extends State<Art_craft_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/art&craft.php";
    // old  table textile
