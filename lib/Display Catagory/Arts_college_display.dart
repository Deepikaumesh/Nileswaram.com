...
class Arts_college_Display extends StatefulWidget {
  @override
  _Arts_college_DisplayState createState() => _Arts_college_DisplayState();
}

class _Arts_college_DisplayState extends State<Arts_college_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/artscollege.php";
    // old  table textile
