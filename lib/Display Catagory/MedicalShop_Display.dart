...
class MedicalShop_Display extends StatefulWidget {
  @override
  _MedicalShop_DisplayState createState() => _MedicalShop_DisplayState();
}

class _MedicalShop_DisplayState extends State<MedicalShop_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/Medicalshop/medicals.php";
    // old  table textile
