...
class Beautician_training_Display extends StatefulWidget {
  @override
  _Beautician_training_DisplayState createState() => _Beautician_training_DisplayState();
}

class _Beautician_training_DisplayState extends State<Beautician_training_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/beautician_training.php";
