...
class Blazers_tie_Display extends StatefulWidget {
  @override
  _Blazers_tie_DisplayState createState() => _Blazers_tie_DisplayState();
}

class _Blazers_tie_DisplayState extends State<Blazers_tie_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/B/blazers_tie.php";
