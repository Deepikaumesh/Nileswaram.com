...
class Artist_Display extends StatefulWidget {
  @override
  _Artist_DisplayState createState() => _Artist_DisplayState();
}

class _Artist_DisplayState extends State<Artist_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/artist.php";
    // old  table textile
