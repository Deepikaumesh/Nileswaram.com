...
class Auto_Gas_Display extends StatefulWidget {
  @override
  _Auto_Gas_DisplayState createState() => _Auto_Gas_DisplayState();
}

class _Auto_Gas_DisplayState extends State<Auto_Gas_Display> {
//Applying get request.

  Future<List<User>> getRequest() async {
    //replace your restFull API here.
    String url =
        "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Display/A/autogas.php";
    // old  table textile
