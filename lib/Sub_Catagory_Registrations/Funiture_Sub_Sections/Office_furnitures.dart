...
class Office_Furnitures_Catagory extends StatefulWidget {
  @override
  _Office_Furnitures_CatagoryState createState() => _Office_Furnitures_CatagoryState();
}

class _Office_Furnitures_CatagoryState extends State<Office_Furnitures_Catagory> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Office_furniture.php";

  @override
  void initState() {
    name = TextEditingController(text: 'office furniture shop-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Office Furnitures",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
