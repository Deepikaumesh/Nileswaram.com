...
class Non_Veg_Catagory extends StatefulWidget {
  @override
  _Non_Veg_CatagoryState createState() => _Non_Veg_CatagoryState();
}

class _Non_Veg_CatagoryState extends State<Non_Veg_Catagory> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Non_Veg_Registration.php";

  @override
  void initState() {
    name = TextEditingController(text: 'non veg hotel-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Non Veg Hotel Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
