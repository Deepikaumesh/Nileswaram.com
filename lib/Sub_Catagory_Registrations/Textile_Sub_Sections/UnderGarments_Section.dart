...
class UnderGarments_Section extends StatefulWidget {
  @override
  _UnderGarments_SectionState createState() => _UnderGarments_SectionState();
}

class _UnderGarments_SectionState extends State<UnderGarments_Section> {
  ...
  @override
  void initState() {
    name = TextEditingController(text: 'undergarments-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("UnderGarments Shop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
