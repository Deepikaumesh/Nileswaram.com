...
class Gents_Section extends StatefulWidget {
  @override
  _Gents_SectionState createState() => _Gents_SectionState();
}

class _Gents_SectionState extends State<Gents_Section> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Gents_RegPage.php";

  @override
  void initState() {
    name = TextEditingController(text: 'gents shop-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Gents Shop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
