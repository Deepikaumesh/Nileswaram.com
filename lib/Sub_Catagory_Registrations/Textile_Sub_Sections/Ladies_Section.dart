...
class Ladies_Section extends StatefulWidget {
  @override
  _Ladies_SectionState createState() => _Ladies_SectionState();
}

class _Ladies_SectionState extends State<Ladies_Section> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/Ladies_Reg_Page.php";

  @override
  void initState() {
    name = TextEditingController(text: 'ladies shop-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Ladies Shop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
