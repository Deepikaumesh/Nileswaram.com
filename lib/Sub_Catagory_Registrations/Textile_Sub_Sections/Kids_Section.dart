...
class Kids_Section extends StatefulWidget {
  @override
  _Kids_SectionState createState() => _Kids_SectionState();
}

class _Kids_SectionState extends State<Kids_Section> {
  ...
  String serverUrl = "https://jcizone19.in/._A_nileswaram/directoryapp/Nileswaram.com/Catagory_Registration/kids_Reg_Page.php";

  @override
  void initState() {
    name = TextEditingController(text: 'kids shop-');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Kids Shop Registration",style: GoogleFonts.prompt(color: Colors.red.shade900),),backgroundColor: Colors.white,
